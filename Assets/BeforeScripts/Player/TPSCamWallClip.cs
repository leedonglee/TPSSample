...
public class TPSCamWallClip : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (m_Fast)
        {
            m_Cam.localPosition = Vector3.Lerp(m_Cam.localPosition, new Vector3(0, 0, -m_CurrentDist - .5f), 5 * Time.deltaTime);
        }
        else if (m_Focus)
        {
            m_Cam.localPosition = Vector3.Lerp(m_Cam.localPosition, new Vector3(0.45f, 0, -(m_CurrentDist - 2f)), 5 * Time.deltaTime);
        }
        else
            m_Cam.localPosition = Vector3.Lerp(m_Cam.localPosition, new Vector3(0, 0, -m_CurrentDist), 5 * Time.deltaTime);
    }
